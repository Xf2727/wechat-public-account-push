export const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: "wx6722e149fdfdfb4c",
  
  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: "9e8c0a3f6ae1be3014abc08bbb5d7af0",
  ...
  USERS: [
    {
      ...
      id: "o6z1n6_-At923TdFLoZloOfj5krM",
      // 你想对他发送的模板消息的模板ID
      useTemplateId: "OKtxBEzByjA8a0P9-dzPieTtenSo3jP6PMUG_2lstvQ",
      // 所在省份
      province: "广东",
      // 所在城市
      city: "肇庆",
